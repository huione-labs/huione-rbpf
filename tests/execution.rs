...
// Copyright 2020 HUIONE Maintainers <maintainers@huione.com>
//
...
extern crate huione_test_utils;
...
fn execute_generated_program(prog: &[u8]) -> bool {
    ...
    {
        let analysis =
            huione_rbpf::static_analysis::Analysis::from_executable(&verified_executable).unwrap();
